#%% [markdown]
# # 🚀 CV4a: v27 Multi-Model + 2-fold TTA + WA Postprocessing
#
# **Phase 1a 목표**: Timeout 해결 + 0.72
#
# **핵심 변경사항**:
# 1. v27 기반 5-모델 앙상블 (v20, v22, v23, v25, v26)
# 2. ⭐ 2-fold TTA (Original, HFlip만) - Timeout 방지
...
def predict_base_with_tta(model, loader, device):
    ...
    tta_transforms = ['original', 'hflip']  # 2-fold TTA (timeout 방지)
